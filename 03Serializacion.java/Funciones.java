...
public class Funciones {
    ...
    private void leerAlumnos() throws Exception{
        //definir ond esta el archivo que esta guardando la nfo
        FileInputStream archivo = new FileInputStream("archivo.dat");
        //generar la lectrura de los objetos
        ObjectInputStream entrada = new ObjectInputStream(archivo);
        //tenemos que transformar los ojetos porque por defecto su lectura en bytes por lo tanto debo castear a un objeto
        listapersonas = (ArrayList)entrada.readObject();

        for(int i = 0; i < listapersonas.size(); i++){
            //recorro lo que necesito del objeto 
            Alumno obj = (Alumno)listapersonas.get(i); //obtiene indice de cada fila
        ...
        private void guardar() throw Exception{
            ...
            FileOutputStream archivo = new FileOutStream("archivo.dat");
            //empiezo a bescribir
